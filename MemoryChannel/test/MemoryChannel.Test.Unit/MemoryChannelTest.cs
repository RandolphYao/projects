...
namespace MemoryChannel.Test.Unit
{
    ...
    public class MemoryChannelTest
    {
        ...
        [Fact]
        public void Pending_ReceiveCompleteAfterSendWithLessDataSize()
        {
            MemoryChannel c = new MemoryChannel();
            byte[] receiveBuffer = new byte[3];
            Task<int> receiveTask = c.ReceiveAsync(receiveBuffer);
        ...
        [Fact]
        public void Pending_receiveCompletes_after_send_with_greater_data_size()
        {
        ...
        [Fact]
        public void Pending_receiveCompletes_afterSendWithGreaterDataSize_followedByAnotherReceiveWithSameDataSize()
        {
            MemoryChannel channel = new MemoryChannel();
            ...
            AssertTaskCompleted(receiveBuffer2.Length, channel.ReceiveAsync(receiveBuffer2));
            Assert.Equal(new byte[] { 4, 5 }, receiveBuffer2);
        }
